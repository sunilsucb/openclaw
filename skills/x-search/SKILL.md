...
python3 {baseDir}/scripts/search.py --model grok-3 "latest AI news"

# Set max response size (bytes, default 2MB)
python3 {baseDir}/scripts/search.py --max-response 1048576 "trending"
```
...
- Retries automatically on rate limits (429) with exponential backoff
